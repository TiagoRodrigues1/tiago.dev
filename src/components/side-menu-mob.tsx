...
export function SideMenuMob(props: SideMenuProps) {
    ...
    () => (
      <div className="flex min-h-screen lg:hidden">
        <div className="flex w-full">
          <ScrollArea className="scrollable-area relative w-full flex-col lg:flex lg:flex-col lg:border-r lg:w-80 xl:w-96">
            <div className="px-5 py-3 border-b">
              <div className="flex justify-between items-center">
                <h4 className="text-sm font-medium leading-none bold ml-15 mt-1">
                  {title}
                </h4>
                {isBookmarksPath && (
